...
If you don't want to install Rust and cargo-contract environment on your local machine, you can use Docker to pull the image to prepare the environment. See the [Tasks](https://docs.patract.io/redspot/tasks) section for details.
...
For more built-in information, see [tasks](https://patractlabs.github.io/substrate-contracts-book/redspot/tasks).
